...
- 現在の即時マイルストーン: `V1-16 flat auto-group semantics / merge grouping` を完了。次は `V1-06 page-first outline / page events` に進む。
- 最新の確認事項:
