...
- 現在のフェーズ: Phase 18 完了。`V1-05 selection / group / z-order foundation` を完了済み。template/UI 系の追加 task `V1-09` 〜 `V1-13` をこのバッチで順に実装中で、現在は `V1-11` を完了し、`V1-12 template slot UI removal` に着手した。
